...
class ChallengeTypesControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create challenge_type" do
    ...
    assert_redirected_to challenge_type_path(assigns(:challenge_type))
  end
  ...
  test "should destroy challenge_type" do
    ...
    assert_redirected_to challenge_types_path
  end
end
