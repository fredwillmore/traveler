...
class CurriculumAreasControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create curriculum_area" do
    ...
    assert_redirected_to curriculum_area_path(assigns(:curriculum_area))
  end
  ...
  test "should destroy curriculum_area" do
    ...
    assert_redirected_to curriculum_areas_path
  end
end
